...
Built from ``kubectl get pods``, one row per container (including init containers).
...
+-------------------------------+---------+------------------------------------------+
| is_init                       | INTEGER | 1 for init containers, 0 for regular     |
+-------------------------------+---------+------------------------------------------+
| cpu_req, gpu_req, mem_req     | REAL    | CPU, GPU and memory requested            |
+-------------------------------+---------+------------------------------------------+
| cpu_lim, gpu_lim, mem_lim     | REAL    | CPU, GPU and memory limits (may be null) |
+-------------------------------+---------+------------------------------------------+
